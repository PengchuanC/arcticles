import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as e,c as s,e as t}from"./app-0P0B6JVZ.js";const a={},i=t(`<p>在编程语言中，string类型往往是通过int数组来实现的，在python中，str和int[]同样可以转换</p><h3 id="_1-str转bytes" tabindex="-1"><a class="header-anchor" href="#_1-str转bytes" aria-hidden="true">#</a> 1.str转bytes</h3><p>将字符串转化为bytes类型，即int数组</p><div class="language-pow line-numbers-mode" data-ext="pow"><pre class="language-pow"><code>&gt;&gt;&gt; a = &#39;abc&#39;
...
&gt;&gt;&gt; bytes(a).decode()
&#39;abc&#39;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,6),d=[i];function r(c,l){return e(),s("div",null,d)}const b=n(a,[["render",r],["__file","python-bytes-str.html.vue"]]);export{b as default};
