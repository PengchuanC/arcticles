import{_ as i}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as o,o as p,c as l,f as c,a as s,b as n,d as e,e as t}from"./app-FWawSowT.js";const r={},d=s("p",null,"Django在3.0正式引入asgi，部署方式与2.x略有不同",-1),u=t(`<h2 id="仅部署http网站" tabindex="-1"><a class="header-anchor" href="#仅部署http网站" aria-hidden="true">#</a> 仅部署http网站</h2><p>如果仅部署http网站，可采用uvicorn来进行部署，然后通过nginx代理地址即可</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token operator">&gt;</span> <span class="token builtin class-name">cd</span> <span class="token punctuation">[</span>your_project<span class="token punctuation">]</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="部署http和websocket" tabindex="-1"><a class="header-anchor" href="#部署http和websocket" aria-hidden="true">#</a> 部署http和websocket</h2>`,5),v={href:"https://channels.readthedocs.io/en/stable/",target:"_blank",rel:"noopener noreferrer"},m=t(`<p>官方推荐使用daphne部署</p><p>以我当前的<code>sma_management</code>项目为例，django3.x版本中，在 <code>sma_management/sma_management/</code>目录下应当有<code>asgi.py</code>文件，引入channels后，应当如下：</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token keyword">import</span> os
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,8),b={href:"http://0.0.0.0/management/",target:"_blank",rel:"noopener noreferrer"};function k(h,g){const a=o("ExternalLinkIcon");return p(),l("div",null,[d,c(" more "),u,s("p",null,[n("Django中websocket功能主要通过"),s("a",v,[n("django-channels"),e(a)]),n("组件实现，由于引入了ws，部署方式略有不同")]),m,s("p",null,[n("这样便可以使用 "),s("a",b,[n("http://0.0.0.0/management/"),e(a)]),n(" 访问http服务，使用 ws://0.0.0.0/ws/ 访问ws服务")])])}const f=i(r,[["render",k],["__file","django-channels-deploy.html.vue"]]);export{f as default};
