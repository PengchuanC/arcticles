...
| -------------- | ------ | --------------- | ----- | ------ | ----- |
| hello(10000)   | 0.001  | 0.001           | 0.003 | 0.001  | 0.011 |
| hello(1000000) | 0.141  | 0.138           | 0.277 | 0.093  | 0.758 |
| fib(40)        | 10.528 | 10.302          | 0.327 | 0.353  | 0.564 |
...
- 执行简单任务时，纯Python的性能优于C/Cython/CPP，主要是因为跨语言对对象进行序列化/反序列化的开销较大；
